...
> [!TIP]
> A schema.org Substance may be a drug or a dietary supplement. The concept systems we are using here to standardize substances your variables measures includes [RxNorm](https://www.nlm.nih.gov/research/umls/rxnorm/overview.html) and [CVX](https://www2a.cdc.gov/vaccines/iis/iisstandards/vaccines.asp?rpt=cvx). RxNorm does NOT include dietery supplements. CVX contains vaccines. There is a gap here we hope to address.
>
